...
def main():
    ...
    models, _ = build_player_models(league, current_week)
    ...
    # ---- baseline (no trade) ----
    baseline_wins, baseline_odds = simulate_remaining_season(league, models, current_week, args.n_sims)
    ...
    trade_wins, trade_odds = simulate_remaining_season(league, models, current_week, args.n_sims, override)
